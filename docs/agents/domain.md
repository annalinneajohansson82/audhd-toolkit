...
Single-context repo. `CONTEXT.md` at the root describes the toolkit's domain
model, components, vocabulary, and design principles. Read it before
exploring issues or making changes.
